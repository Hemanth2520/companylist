...
export default function FranchisesPage() {
  ...
  const [appliedFilters, setAppliedFilters] = useState({ industry: 'Franchise' });
  ...
  const fetchCompanies = useCallback(async () => {
    ...
    try {
      ...
      // Default to Franchise if no other industry is selected
      if (!params.industry) params.industry = 'Franchise';
      ...
      if (activeTab !== 'All Industries') {
        ...
        filtered = filtered.filter((c) => c.industry === 'Franchise');
      }
    ...
    <div className="franchises-page">
      <section className="hero">
        <div className="container hero__content">
          <h1>Explore <span className="gold-text">Franchise</span> Opportunities</h1>
          <p className="hero__sub">
            Discover proven business models and scale your entrepreneurial journey
          </p>
          <div className="hero__stats">
            <div className="hero__stat">
              <span className="hero__stat-num">1,200+</span>
              <span className="hero__stat-label">Franchises</span>
            </div>
            <div className="hero__stat">
            ...
            <div className="hero__stat">
              ...
              <span className="hero__stat-label">Avg Capital</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main className="main-content">
            ...
            <div className="results-bar">
              <p className="results-bar__count">
                ...
                <strong>{totalCount.toLocaleString()}</strong> franchises
              </p>
              ...
              {loading
                ...
                ? (
                  <div className="empty-state">
                    ...
                    <p>Try adjusting your filters to find the right opportunity.</p>
                  </div>
                )
