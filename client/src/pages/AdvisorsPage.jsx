...
export default function AdvisorsPage() {
  ...
  const [appliedFilters, setAppliedFilters] = useState({ badge: 'VERIFIED' });
  ...
  const fetchCompanies = useCallback(async () => {
    ...
    try {
      ...
      if (appliedFilters.badge === 'VERIFIED') {
        filtered = filtered.filter(c => c.badge === 'VERIFIED');
      }
    ...
    <div className="advisors-page">
      <section className="hero">
        <div className="container hero__content">
          <h1>Professional <span className="gold-text">Advisory</span> Portal</h1>
          <p className="hero__sub">
            Curated high-value listings for strategic consultants and business advisors
          </p>
          <div className="hero__stats">
            <div className="hero__stat">
              <span className="hero__stat-num">500+</span>
              <span className="hero__stat-label">Verified Deals</span>
            </div>
            <div className="hero__stat">
            ...
            <div className="hero__stat">
              <span className="hero__stat-num">$1B+</span>
              <span className="hero__stat-label">Advisory Volume</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main className="main-content">
            ...
            <div className="results-bar">
              <p className="results-bar__count">
                ...
                <strong>{totalCount.toLocaleString()}</strong> verified opportunities
              </p>
              ...
              {loading
                ...
                ? (
                  <div className="empty-state">
                    ...
                    <h3>No verified deals found</h3>
                    <p>Adjust your filters to find the right opportunity for your client.</p>
                  </div>
                )
